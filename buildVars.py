...
addon_info = AddonInfo(
	...
	# version
	addon_version="2026.9.1.1",
	# Brief changelog for this version
	# Translators: what's new content for the add-on version to be shown in the add-on store
	addon_changelog=_("""Исправление: копирование и вставка переведены на прямой ввод клавиш — команды снова работают в приложениях, где раньше появлялась ошибка «Не удалось вставить исправленный текст». Переключение раскладки теперь переводит знаки препинания по физическим клавишам: «@#$%^&» → «"№;%:?», «?» и «/» преобразуются однозначно. Звуковой сигнал подаётся только после того, как исправленный текст действительно вставлен."""),
	# Author(s)
	addon_author="R1BQE",
...
pythonSources: list[str] = [
	"addon/*.py",
	"addon/globalPlugins/Text_Fixer/*.py",
]
